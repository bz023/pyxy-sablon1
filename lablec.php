			...
			<div class="section">
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								<h3 class="footer-title">Infordmációk</h3>
								<ul class="footer-links">
									<li><a href="#">Rólunk</a></li>
									<li><a href="#">Lépjen kapcsolatba velünk</a></li>
									<li><a href="#">Adatvédelmi irányelvek</a></li>
									<li><a href="#">Megrendelések és visszaküldések</a></li>
